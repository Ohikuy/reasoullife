...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <button id="themeToggleBtn">1黑</button>
            <div id="title">
                一个魂重开模拟器<br>
                <div style="font-size:1.5rem; font-weight:normal;">这就重开到枝江</div>
            </div>
            <button id="restart" class="mainbtn"><span class="iconfont">&#xe6a7;</span>笑死</button>
        ...
        trajectoryPage
            ...
            .click(()=>{
                ...
                const li = $(`<li><span>${age}天：</span><span>${
                    content.map(
